class SkillCalc:
    def __init__(self, verbose = False):
        self.k_factor = 32 #TODO there should be 2 values, one for winner and loser. when we have implemented ELO confidence value. example high ELO user will not lose a lot of points if new team with base/low ELO beats them
